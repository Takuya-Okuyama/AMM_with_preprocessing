...
./AMM -m 4096 -k 4096 -n 4096 -c 256 -r 1000 -kernel previousAMM -matrixType_A gaussian_1.0_1.0 -matrixType_B gaussian_1.0_1.0 -seed 1 -alpha 1.0 -beta 0.0 -sanity -verbose 2
